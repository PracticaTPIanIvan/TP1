...
public class GamePrinter {
	...
	private static final String[] GAME_OBJECTS_INFO = {Coin.INFO, Grenade.INFO,  Obstacle.INFO,
			Pedestrian.INFO, SuperCoin.INFO, Truck.INFO, Turbo.INFO, Wall.INFO};
	...
	private String getInfo() {
		...
		res += "Distance: " + (game.getRoadLength() - game.getPlayerPositionX()) + "\n" +
				...
				"Cycle: " + game.getCycle() + "\n" +
				"Total Obstacles: " + (Obstacle.counter + Wall.counter + Truck.counter + Pedestrian.counter) + "\n" +
